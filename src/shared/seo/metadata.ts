...
const pages: Record<string, [string, string]> = {
  ...
  '/calculator': ['Калькулятор рельсов и крепежа по ГОСТ | ИНВИА', 'Онлайн-калькулятор материалов ВСП: метры рельсов в тонны, штуки крепежа в килограммы, ведомость рельсов, шпал и скреплений на километр пути. Массы — по ГОСТ.'],

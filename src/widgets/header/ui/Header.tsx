...
export function Header() {
  ...
  return (
    ...
    >
      ...
      <div
        className="header-meta header-topbar bg-muted text-muted-foreground"
        inert={scrolled}
      >
        <div>
          <div className="container mx-auto flex items-center justify-between gap-4 px-6 py-2 text-[13px] xl:px-8">
            ...
            <div className="hidden items-center gap-5 md:flex">
              ...
              {/* Между 1024 и 1280 рядом с меню почта и часы не влезают
                  в одну строку — часы прячем, они есть в «Контактах». */}
              <span className="whitespace-nowrap lg:hidden xl:inline">Пн–Пт, 8:00–17:00</span>
      ...
      <div className="container relative mx-auto px-6 xl:px-8">
        <div className="header-main flex items-center gap-3 xl:gap-5">
          ...
          {/* Два номера столбиком, почта — в серой полосе над шапкой. */}
